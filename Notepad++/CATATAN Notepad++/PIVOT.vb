...
Set DataSrc = twb.Sheets("tes2") ' Ganti "DataSheet" dengan nama lembar kerja sumber Anda.
Set PivotSheet = twb.Sheets("tes3") ' Membuat lembar kerja baru untuk Pivot Table.

twb.Sheets("tes3").Select
' Loop melalui semua PivotTables di lembar kerja PivotSheet
For Each PivotTable In PivotSheet.PivotTables
    If PivotTable = "PV_PerBuyer" Then
...
End With
With PivotTable.PivotFields("Buyer")
    .Caption = "Buyer"
    .Orientation = xlRowField
    .Position = 3
End With
With PivotTable.PivotFields("Pv-QTY")
...
End With
With PivotTable.PivotFields("Pv-Am.FOB")
    .Orientation = xlDataField
    .Position = 2
    .Function = xlSum
...
End With
With PivotTable.PivotFields("Pv-Amt.CM(USD)")
    .Orientation = xlDataField
    .Position = 3
    .Function = xlSum
    ...
    .NumberFormat = "_($* #,##0.00_);[Red]_($* (#,##0.00);_(* ""-""??_);_(@_)"
End With
With PivotTable.PivotFields("Pv-Cost.Line(USD)")
    .Orientation = xlDataField
    .Position = 4
    .Function = xlSum
    ...
    .NumberFormat = "_($* #,##0.00_);[Red]_($* (#,##0.00);_(* ""-""??_);_(@_)"
End With
With PivotTable.PivotFields("Pv-Profit.Lost(USD)")
    .Orientation = xlDataField
    .Position = 5
    .Function = xlSum
    ...
    .NumberFormat = "_($* #,##0.00_);[Red]_($* (#,##0.00);_(* ""-""??_);_(@_)"
End With
With PivotTable.PivotFields("Pv-%")
    .Orientation = xlDataField
    .Position = 6
    .Function = xlSum
    .Caption = "Sum of %"
    .NumberFormat = "0%;[Red]-0%;_(* ""-""??_);_(@_)"
End With
...
ActiveSheet.PivotTables("PV_PerBuyer").PivotSelect "'Sum of %'", _
        xlDataAndLabel, True
With Selection
...
' GANTI NAMA FACTORY
ActiveSheet.PivotTables("PV_PerBuyer").PivotSelect _
