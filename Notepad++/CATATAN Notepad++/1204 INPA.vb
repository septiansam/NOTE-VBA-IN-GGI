...
' -----------------------------------------------------------------------------------------------------------
    ...
    SH1_OLAH1.Range("P2:P" & LR1).FormulaR1C1 = "=IFERROR(VLOOKUP(RC[-4],OLAH2!C[-4]:C,5,FALSE),CONCATENATE(OLAH1!RC[-3],OLAH1!RC[-2],OLAH1!RC[-1]))"
...
''[09/11/2024 TANPA PIVOT]
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
'    Stop
'    SH1_OLAH1.Activate
'    SH1_OLAH1.AutoFilterMode = False
'    LR1 = SH1_OLAH1.Range("A" & Rows.Count).End(xlUp).Row
''    SH1_OLAH1.Range("V1").FormulaR1C1 = "PK (ITEM-LOT-BUYER)"
'    SH1_OLAH1.Range("V2:V" & LR1).FormulaR1C1 = "=IFERROR(IF(AND(CLEAN(TRIM(RC[-9])=""""),CLEAN(TRIM(RC[-12])="""")),FALSE,RC[-21]&""-""&RC[-12]&""-""&RC[-9]),FALSE)"
'    SH1_OLAH1.Range("W1").FormulaR1C1 = "FILTER 1"
'    SH1_OLAH1.Range("W2:W" & LR1).FormulaR1C1 = "=IF(RC[-1]=FALSE,FALSE,COUNTIF(R1C22:RC[-1],RC[-1]))"
'    SH1_OLAH1.Range("X1").FormulaR1C1 = "Sum of QTY.PRIMARY"
'    SH1_OLAH1.Range("X2:X" & LR1).FormulaR1C1 = "=IF(RC[-1]=1,SUMIF(R2C22:R" & LR1 & "C22,RC[-2],R2C17:R" & LR1 & "C17),"""")"
'    SH1_OLAH1.Range("Y1").FormulaR1C1 = "Sum of EXTENDED AMT"
'    SH1_OLAH1.Range("Y2:Y" & LR1).FormulaR1C1 = "=IF(RC[-2]=1,SUMIF(R2C22:R" & LR1 & "C22,RC[-3],R2C18:R" & LR1 & "C18),"""")"
'
'    SH1_OLAH1.Range("V3:Y" & LR1).Copy
'    SH1_OLAH1.Range("V3:Y" & LR1).PasteSpecial xlPasteValuesAndNumberFormats: Application.CutCopyMode = False
''
'    SH1_OLAH1.Range("A1:Y" & LR1).AutoFilter 23, "1"
'    SH1_OLAH1.Range("A1:Y" & LR1).SpecialCells(xlCellTypeVisible).Copy
'
'    SH1_OLAH2.Activate
'    SH1_OLAH2.Range("A1").PasteSpecial xlPasteValuesAndNumberFormats
'    SH1_OLAH2.Cells.EntireColumn.AutoFit
'    SH1_OLAH2.Cells(1, 1).Select
'    SH1_OLAH3.Activate
...
'    Stop
    ...
    LR1 = SH1_OLAH3.Cells.Find("*", , xlFormulas, xlPart, xlByRows, xlPrevious).Row
    
    '--->[HANYA ITEM YG ADA DI INV AGING]
    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
'    Stop
'    SH1_OLAH3.AutoFilterMode = False
'    SH1_OLAH3.Range("D:H").Delete
'    SH1_OLAH3.Range("D1") = "LOC"
'    SH1_OLAH3.Range("E1") = "LOT"
'    SH1_OLAH3.Range("F:G").Delete
'    SH1_OLAH3.Range("G:L").Delete
'    SH1_OLAH3.Range("H:J").Delete
...
'    SH1_OLAH3.Range("M2:M" & LR1).FormulaR1C1 = "=IFERROR(VLOOKUP(RC[-12],INVENTORY_AGING!C1:C15,15,FALSE),"""")"
    ...
    SH1_OLAH3.Range("M:N").PasteSpecial xlPasteAll, xlPasteSpecialOperationAdd: Application.CutCopyMode = False
